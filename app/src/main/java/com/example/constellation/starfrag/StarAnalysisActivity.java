...
//      加载ListView当中的数据源内容
    private void addDataToList() {
        ...
        StarAnalysisBean sab2 = new StarAnalysisBean("掌管星宫 :", bean.getGw(), R.color.lightpink);
    ...
    private void initView() {
        ...
        iconIv = findViewById(R.id.staranalaysis_iv);
        nameTv = findViewById(R.id.staranalaysis_tv_name);
        dateTv = findViewById(R.id.staranalaysis_tv_date);
        analysisLv = findViewById(R.id.staranalaysis_lv);
